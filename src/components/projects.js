...
import flexible from './flexible-webpage.png'
import music from './homepage.png'
import pasta from './pasta_king.png'
import book from './book_app_interface.png'
import portfolio from './portfolio.png'

import { Tab,Tabs, Grid, Cell, Card, CardActions, CardMenu, IconButton, Button, CardTitle, CardText } from 'react-mdl';
        ...
        if(this.state.activeTab === 0){
            ...
            <div  className = "projects-grid" >
                    ...
                    <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                         <CardTitle style={{color: '#fff', height: '176px', background: `url(${tribute}) center / cover`}}>HTML/CSS3</CardTitle>
                            <CardText> A web responsive tribute page created with HTMl and CSS </CardText>
                            <CardActions border>
                    ...
                    <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                         <CardTitle style={{color: '#fff', height: '176px', background: `url(${survey}) center / cover`}}>HTML/CSS3</CardTitle>
                            <CardText> A web responsive tribute page created with HTMl and CSS </CardText>
                            <CardActions border>
                              <Button colored>GitHub</Button>
                              <Button colored>CodePen</Button>
                    ...
                    <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                         <CardTitle style={{color: '#fff', height: '176px', background: `url(${flexible}) center / cover`}}>HTML/CSS3</CardTitle>
                            <CardText> A web responsive tribute page created with HTMl and CSS</CardText>
                            <CardActions border>
                              <Button colored>GitHub</Button>
                              <Button colored>CodePen</Button>
            ...
            return(
                <div  className = "projects-grid">               
                    <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                         <CardTitle style={{color: 'black', height: '176px', background: `url(${music}) center / cover`}}>BOOTSTRAP 4</CardTitle>
                            <CardText> A responsive web page styled with Bootstrap 4 </CardText>
                            <CardActions border>
                              <Button colored>GitHub</Button>
                              <Button colored>CodePen</Button>
                            </CardActions>
                    ...
                    <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                         <CardTitle style={{color: 'white', height: '176px', background: `url(${pasta}) center / cover`}}>BOOTSTRAP 4</CardTitle>
                            <CardText> A responsive web page styled with Bootstrap 4 </CardText>
                            <CardActions border>
                              <Button colored>GitHub</Button>
                              <Button colored>CodePen</Button>
            ...
            return(
                <div  className = "projects-grid" >
                    <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                         <CardTitle style={{color: '#fff', height: '176px', background: `url(${book}) center / cover`}}>JAVASCRIPT</CardTitle>
                            <CardText> A Vanilla JavaScript project that does DOM manupulations and Uses web storage </CardText>
                            <CardActions border>
                              <Button colored>GitHub</Button>
                              <Button colored>CodePen</Button>
                            </CardActions>
            ...
            return(
                <div  className = "projects-grid" >
                <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                     <CardTitle style={{color: '#fff', height: '176px', background: `url(${portfolio}) center / cover`}}>REACT</CardTitle>
                        <CardText> A react based portfolio website</CardText>
                        <CardActions border>
                          <Button colored>GitHub</Button>
                          <Button colored>CodePen</Button>
                        </CardActions>
            ...
            return(
                <div  className = "projects-grid" >
                <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                     <CardTitle style={{color: 'black', height: '176px', background: `url(${music}) center / cover`}}>PYTHON DJANGO</CardTitle>
                        <CardText> A react based portfolio website</CardText>
                        <CardActions border>
                          <Button colored>GitHub</Button>
                          <Button colored>CodePen</Button>
